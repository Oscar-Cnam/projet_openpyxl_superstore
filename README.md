...
| :--------------- |:----:| :----------------|
| Row ID  |   character        |  Identifiant unique pour chaque ligne |
| Order ID | character | Identifiant unique pour chaque commande |
| Order Date | date | Date au moment de l'achat |
| Ship Date | date | Date de livraison d'un produit |
| Ship Mode | character | Mode de livraison spécifié par le client |
| Customer ID | character | Identifiant unique pour identifier chaque client |
| Customer Name | character | Nom et prénom du client |
...
| Product ID | character | Identifiant unique du produit |
